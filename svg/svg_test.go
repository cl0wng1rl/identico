...
func TestToString(t *testing.T) {
	svgElement := New()
	expectedSVG := `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 8" shape-rendering="crispEdges"></svg>`
...
func TestAddElementAndToString(t *testing.T) {
	...
	expectedSVG := `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 8" shape-rendering="crispEdges"><rect fill="testColor" x="0" y="0" width="1" height="1" /></svg>`
	if svgElement.ToString() != expectedSVG {
